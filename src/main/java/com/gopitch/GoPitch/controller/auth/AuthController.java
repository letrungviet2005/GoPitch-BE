package com.gopitch.GoPitch.controller.auth;
...
public class AuthController {
    ...
    public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody ReqLoginDTO loginDTO) {
        ...
        String accessToken = this.securityUtil.createAccessToken(
                authentication.getName(), res, this.userService.buildJwtAuthorities(currentUser));
    ...
    public ResponseEntity<ResLoginDTO> getRefreshToken(
        ...
        String newAccessToken = this.securityUtil.createAccessToken(
                newAuthentication.getName(), res, this.userService.buildJwtAuthorities(currentUserDB));
